...
## 2026-05-15 - Refuerzo de Healthcheck y Utilidades de Flota | Impacto: Reducción de errores de configuración y mejor descubrimiento de herramientas de orquestación | Regla: Validar autenticación de gh como requisito crítico y promover scripts de flota en package.json.
